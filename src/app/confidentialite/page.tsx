        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-[#e0e6f0]">
            ...
            <section>
              ...
              <p>
                Pour exercer ces droits, contactez-nous à : <a href="mailto:contact@qrtag.com" className="text-[#b8860b] hover:underline">contact@qrtag.com</a>
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Email :</strong> <a href="mailto:contact@qrtag.com" className="text-[#b8860b] hover:underline">contact@qrtag.com</a><br />
