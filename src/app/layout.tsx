...
export const metadata: Metadata = {
  title: {
    default: "QRTags - Protection intelligente des objets",
    template: "%s | QRTags",
  },
  description: "Protégez vos objets avec un autocollant QR intelligent. Sans application, sans batterie, sans GPS. Un seul scan pour la tranquillité d'esprit.",
  keywords: ["QR", "objet", "voyage", "hajj", "protection", "sticker", "luggage", "travel", "pèlerinage", "qrtags"],
  ...
  // Open Graph
  openGraph: {
    title: "QRTags - Protection intelligente des objets",
