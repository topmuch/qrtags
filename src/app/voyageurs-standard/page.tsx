      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-[#1a2238] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://facebook.com/qrtag" target="_blank" rel="noopener noreferrer" className="text-[#a0a8b8] hover:text-[#1D4ED8] transition-colors" aria-label="Facebook">
              <Facebook className="w-5 h-5" aria-hidden="true" />
            </a>
            <a href="https://instagram.com/qrtag" target="_blank" rel="noopener noreferrer" className="text-[#a0a8b8] hover:text-[#1D4ED8] transition-colors" aria-label="Instagram">
              <Instagram className="w-5 h-5" aria-hidden="true" />
            </a>
            <a href="https://twitter.com/qrtag" target="_blank" rel="noopener noreferrer" className="text-[#a0a8b8] hover:text-[#1D4ED8] transition-colors" aria-label="Twitter">
