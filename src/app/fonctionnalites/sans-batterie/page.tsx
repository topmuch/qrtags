          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody className="text-sm">
                {[
                  { criterion: 'Batterie requise', qrtag: 'Aucune', tracker: 'Pile à remplacer tous les 6-12 mois' },
                  { criterion: 'Coût initial', qrtag: '5€/an', tracker: '30-150€ + abonnement' },
                  { criterion: 'Autonomie', qrtag: 'Illimitée', tracker: 'Limitée par la durée de la batterie' },
                  { criterion: 'Poids', qrtag: '< 1 gramme', tracker: '20-50 grammes' },
                  { criterion: 'Risque de panne', qrtag: 'Aucun', tracker: 'Batterie morte = protection morte' },
                  { criterion: 'Compatibilité', qrtag: 'Tous les téléphones', tracker: 'Écosystème limité (Apple, Samsung...)' },
                  { criterion: 'Visibilité', qrtag: 'Visible et identifiable', tracker: 'Caché, difficile à trouver' },
                ].map((row, i) => (
                  <tr key={i} className="border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-4 px-6 text-center">
                      <span className="inline-flex items-center gap-1.5 text-amber-700 font-semibold">
                        <CheckCircle className="w-3.5 h-3.5 text-amber-500" /> {row.qrtag}
                      </span>
                    </td>
