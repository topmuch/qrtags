          ...
          <div className="space-y-8 text-[#e0e6f0]">
            <section>
              ...
              <p>
                ...
                <strong>Email :</strong> contact@qrtag.com<br />
            ...
            <section>
              ...
              <p>
                Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez d&apos;un droit d&apos;accès, de rectification, de suppression et de portabilité de vos données personnelles. Pour exercer ces droits, vous pouvez nous contacter à : contact@qrtag.com.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Pour toute question relative aux présentes mentions légales, vous pouvez nous contacter à : <a href="mailto:contact@qrtag.com" className="text-[#b8860b] hover:underline">contact@qrtag.com</a>
              </p>
            </section>
          </div>
